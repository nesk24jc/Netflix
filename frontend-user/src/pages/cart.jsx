...
function Cart() {
  const { cart, getCartTotal, clearCart, rentAllInCart, removeFromCart } = useCart();
  ...
  const handleRentAll = () => {
    ...
    if (result.success) {
      ...
      // Affichez la page des locations
      navigate("/rentals");
    }
  };
          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            {cart.map((movie) => (
              ...
              >
                ...
                <button
                  onClick={() => removeFromCart && removeFromCart(movie.id)}
              ...
              <div className="space-y-3 mb-6">
                ...
                <div className="flex justify-between text-2xl font-bold">
                  ...
                  <span className="text-primary">
                    {getCartTotal && getCartTotal().toFixed(2)}€
                  </span>
                </div>
              </div>
